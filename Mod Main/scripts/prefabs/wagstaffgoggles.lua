function MakeGoggle(name)
	...
	if name == "wagstaffgoggles_normal" then
		fn = normal
	elseif name == "wagstaffgoggles_nightvision" then
		fn = heat
	elseif name == "wagstaffgoggles_armor" then
		fn = armor
	elseif name == "wagstaffgoggles_shoot" then
		fn = shoot		
	end
...
return MakeGoggle("wagstaffgoggles_normal"),
	   MakeGoggle("wagstaffgoggles_nightvision"),
	   MakeGoggle("wagstaffgoggles_armor"),
	   MakeGoggle("wagstaffgoggles_shoot")