Assets = {
	...
	Asset("ATLAS", "images/map_icons/mc_wagstaff.xml" ),
	Asset("IMAGE", "images/map_icons/mc_wagstaff.tex" ),
	...
	-- Asset("ATLAS", "images/inventoryimages/wagstaff_telipad.tex"),
...
AddMinimapAtlas("images/map_icons/mc_wagstaff.xml")
